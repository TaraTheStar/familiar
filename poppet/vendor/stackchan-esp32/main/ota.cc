...
esp_err_t Ota::CheckVersion() {
    ...
    if (cJSON_IsObject(server_time)) {
        ...
        if (cJSON_IsNumber(timestamp)) {
            ...
            // If there is a timezone offset, compute the local time
            ...
            tv.tv_usec = (suseconds_t)((long long)ts % 1000) * 1000;  // Convert the remaining milliseconds to microseconds
