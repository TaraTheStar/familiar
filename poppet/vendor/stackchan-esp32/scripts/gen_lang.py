...
def generate_header(lang_code, output_path):
    # Infer the project structure from the output path
    ...
    # Merge strings: use en-US as the base, overridden by the user language
    ...
    # Collect sound files: use en-US as the base, overridden by the user language
    ...
    # Merge the sound file lists: user language overrides the base language
    ...
    for file in sorted(all_sound_files):
        ...
        # Prefer the current language's sound; fall back to en-US if it does not exist
